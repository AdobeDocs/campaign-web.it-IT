---
title: Utilizzare GenStudio for Performance Marketing in Adobe Campaign
description: Scopri come utilizzare GenStudio for Performance Marketing in Adobe Campaign
...
# Utilizzare GenStudio for Performance Marketing {#genstudio}
...
## Utilizzare le funzionalità di GenStudio in Adobe Campaign {#use-genstudio}

L&#39;integrazione di [!DNL GenStudio for Performance Marketing] e [!DNL Adobe Campaign] consente agli addetti al marketing della tua azienda di collaborare meglio per semplificare i processi.

Ad esempio, un esperto di marketing tecnico, che utilizza [!DNL Adobe Campaign] per sviluppare e automatizzare campagne e-mail, può collaborare con un esperto di marketing delle prestazioni che crea contenuti utilizzando [!DNL GenStudio].

Con questa integrazione, entrambi possono collaborare per integrare facilmente i contenuti del brand da [!DNL GenStudio] a [!DNL Adobe Campaign], distribuendo e-mail coinvolgenti che mirano a segmenti di clienti specifici e stimolano le vendite.

### Esportare un modello di HTML da Adobe Campaign a GenStudio {#export-from-campaign-to-genstudio}

È innanzitutto possibile esportare un modello di HTML [!DNL Adobe Campaign] contenente le linee guida del brand in [!DNL GenStudio for Performance Marketing]. Segui i passaggi seguenti.

1. In [!DNL Adobe Campaign], accedere al contenuto dell&#39;e-mail. [Scopri come](../email/create-email.md#create-content)
...
### Sfruttare le esperienze GenStudio in Adobe Campaign {#leverage-genstudio-experiences}

Per sfruttare le varianti di e-mail [!DNL GenStudio] create importandole in [!DNL Adobe Campaign], attieniti alla procedura seguente.

1. In [!DNL Adobe Campaign], [crea una consegna e-mail](../email/create-email.md).

1. Nella dashboard della consegna e-mail, fai clic sul pulsante **[!UICONTROL Modifica contenuto]**. [Ulteriori informazioni](../email/create-email.md#create-content)
...
1. Il contenuto selezionato viene visualizzato in E-mail Designer.
   ...
   >[!NOTE]
   >
   >Le esperienze GenStudio [create da un [!DNL Adobe Campaign] modello](#export-from-ajo-to-genstudio) vengono importate direttamente nel Designer di posta elettronica. Le esperienze GenStudio create senza un modello [!DNL Adobe Campaign] vengono importate in [modalità di compatibilità](../email/existing-content.md).

   Utilizza gli [strumenti di modifica del contenuto e-mail](../email/create-email-content.md) e i [campi di personalizzazione](../personalization/personalize.md) per modificare l&#39;e-mail come desiderato. Salva il contenuto.
