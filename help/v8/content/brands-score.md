...
# Valutare i contenuti {#brands-score}
...
* **Allineamento marchio**: rivedi e gestisci contenuti sempre conformi alle linee guida del tuo marchio. Questo garantisce coerenza nel tono, nei messaggi e nell’identità visiva in tutte le campagne e-mail.
* **Controllo qualità**: convalida il contenuto prima che venga pubblicato per mantenere standard elevati e l&#39;integrità del marchio.
...
1. Crea la [consegna e-mail](../email/create-email.md).
