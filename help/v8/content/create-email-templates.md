...
1. Fai clic su **[!UICONTROL Crea]** e scegli la modalità di progettazione del modello tra le diverse opzioni:
   ...
   * [Progetta il contenuto da zero](../email/create-email-content.md) tramite l&#39;interfaccia di E-mail Designer.
   * [Codice o copia-incolla HTML non elaborato](../email/code-content.md) direttamente nel Designer e-mail.
...
1. Viene visualizzato E-mail Designer. Modifica il contenuto in base alle esigenze, come faresti per qualsiasi e-mail, in base all’opzione selezionata. Scopri come utilizzare il Designer e-mail in [questa sezione](../email/get-started-email-designer.md).
...
Dopo aver [progettato un&#39;e-mail](../email/create-email-content.md), puoi salvarne il contenuto come modello da riutilizzare in futuro. I modelli salvati sono disponibili per tutti gli utenti dell’ambiente Adobe Campaign.
...
1. Fai clic sul pulsante **[!UICONTROL Modifica contenuto]** per aggiornare il contenuto con [Invia e-mail a Designer](../email/get-started-email-designer.md).
