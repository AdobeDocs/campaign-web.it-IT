...
Per ulteriori informazioni su Esplora campagne, consulta questa [Documentazione della console di Campaign v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/campaign-ui.html?lang=it#ac-explorer-ui){target="_blank"}.
<!--
