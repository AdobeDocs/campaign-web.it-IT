...
>[!TAB Genera contenuti]

✨ Immergiti in un’esperienza pratica con la nostra anteprima live di [Genera contenuti](../v8/content/generative-gs.md), progettata per consentirti di esplorarne le funzioni in prima persona e comprenderne appieno le funzionalità.
...
* [Pixel di tracciamento delle e-mail e linee guida CNIL](https://experienceleague.adobe.com/it/docs/campaign/campaign-v8/new/cnil-pixel-tracking){target="_blank"}