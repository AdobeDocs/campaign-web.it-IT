...
![Schermata di un grafico con dati](assets/reporting_email_1.png){zoomable="yes"}
...
![Schermata della velocità effettiva di consegna](assets/reporting_email_3.1.png){zoomable="yes"}{align="center" zoomable="yes"}
...
![Schermata del raggruppamento degli errori per dominio](assets/campaign_report_email_6.1.png){zoomable="yes"}{align="left" zoomable="yes"}

Fai clic sull’icona accanto al nome di ciascun dominio per visualizzare i dettagli.

![Schermata della suddivisione degli errori per dominio con i dettagli di ciascun dominio](assets/campaign_report_email_6.1.png){zoomable="yes"}{align="left" zoomable="yes"}
...
![Schermata della suddivisione dei clic sul grafico del tempo](assets/reporting_email_9.png){zoomable="yes"}{align="center"}
...
![Schermata del report Raggruppamento per dispositivo](assets/reporting_email_13.png){zoomable="yes"}{align="center"}
...
![Schermata del rapporto Raggruppamento per sistema operativo](assets/reporting_email_13.1.png){zoomable="yes"}{align="center"}
...
![Schermata della suddivisione delle aperture per report del browser](assets/reporting_email_13.2.png){zoomable="yes"}{align="center"}
...
![Schermata del report Hotclick](assets/reporting11.png){zoomable="yes"}