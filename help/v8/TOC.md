...
+ Note sulla versione {#release-notes}
  ...
  + {hide-from-toc}[Aggiornamenti alla documentazione](rn/documentation-updates.md)
+ Introduzione ad Adobe Campaign {#start}
  ...
  + [Selezionare gli attributi e aggiungerli ai preferiti](get-started/attributes.md)
...
+ Messaggi e consegne {#msg}
  ...
  + LINE {#line}
    + [Introduzione a LINE](line/get-started-line.md)
    + [Inviare un messaggio LINE](line/send-line.md)
...
+ Gestione dei contenuti {#content}
  ...
  + Riutilizzare il contenuto {#manage-reusable-content}
    + Modelli di contenuto {#content-templates}
      ...
      + [Bloccare il contenuto nei modelli e-mail](content/content-locking.md)
  ...
  + Progettare le e-mail {#email-design}
    ...
    + Iniziare a definire l’e-mail {#start-design}
      ...
      + [Applicare temi al contenuto dell’e-mail](email/apply-email-themes.md)
  ...
  + Generare contenuti {#ai-assistant}
    ...
    + [Metadati C2PA in Designer e-mail e Designer pagine di destinazione](content/c2pa-metadata-email-designer.md)
    + Brand {#ai-assistant}
...
+ Flussi di lavoro {#wf}
  ...
  + Utilizzare le attività del flusso di lavoro {#design-workflows}
    ...
    + [Caricamento dati (RDBMS)](workflows/activities/data-loading-rdbms.md)
...
+ Eseguire query sul database {#query-database}
  ...
  + {hide-from-toc}[Esempi di query](query/query-samples.md)
...
+ Configurazione {#conf}
  ...
  + [Utilizzare pagine JavaScript dinamiche](administration/dynamic-javascript-pages.md)
