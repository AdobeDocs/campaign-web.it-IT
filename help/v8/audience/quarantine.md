...
Se una consegna ha un’alta percentuale di indirizzi non validi, può essere considerata spam. La gestione di tali indirizzi con la quarantena aiuta a evitare che vengano dai provider Internet. Questo è importante per mantenere la tua reputazione.
...
* Per l’e-mail, quando il messaggio viene segnalato come spam. Il messaggio viene automaticamente reindirizzato a una casella di posta tecnica gestita da Adobe. L’indirizzo e-mail dell’utente viene quindi messo automaticamente in quarantena con lo stato di.
